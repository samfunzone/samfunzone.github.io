...
const JOKES = [
  ...
  { setup: "What do you call a fake noodle?",              punchline: "An im-pasta! 🍝" },
  { setup: "What do you call a penguin in the desert?",   punchline: "Lost! 🐧🏜️" },
  ...
  { setup: "What do you call a duck that loves fireworks?", punchline: "A firequacker! 🦆🎆" },
  ...
  { setup: "Why did the orange stop halfway up the hill?", punchline: "It ran out of juice! 🍊" },
  { setup: "What do you call a dog that can do magic tricks?", punchline: "A labracadabrador! 🐕✨" },
  ...
  { setup: "Why did the bee get married?",               punchline: "Because it found its honey! 🐝💛" },
  { setup: "What do you call a parrot that flew away?",   punchline: "A polygon! 🦜" },
  { setup: "Why was the baby strawberry crying?",        punchline: "Its parents were in a jam! 🍓😢" },
  { setup: "What do you call a boomerang that won't come back?", punchline: "A stick! 🪃" },
  { setup: "What's a frog's favorite snack?",            punchline: "A hop-corn! 🐸🍿" },
  { setup: "Why did the cookie cry?",                    punchline: "Its mom was a wafer too long! 🍪💧" },
